...
public class MenuAndKind{
    ...
    public MenuAndKind(String mId, String mName, String mWay, String mFlavor, String mIng, Long mPrice, String mPic, String kId,
                        String kName, String kMain){
        this.mId = mId;
        this.mName = mName;
        this.mWay = mWay;
